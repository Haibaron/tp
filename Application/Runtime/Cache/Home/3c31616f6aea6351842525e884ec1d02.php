...
<head>
	...
	<link rel="stylesheet" href="<?= '/tpshop2/Public/css/list.css' ?>" />
	...
	<div class="container">
		...
		<div class="row">
			<?php foreach ($v as $p) { ?> 
					...
					<img class="product_item_img" src="/tpshop2<?=($p['img']) ?>" />
					<ul class="clearfix">
...
<script type="text/javascript" src="<?php echo '/tpshop2/Public/js/bootstrap.min.js'?>"></script>
