	                        ...
	                        <form  method="post" action="<?=U('Admin/Productcatalog/do_add')?>"  class="form-horizontal">
	                          ...
	                          <div class="form-group">
	                              ...
	                              <div class="col-sm-8">
	                              	...
	                              	<?php if(is_array($level1)): $i = 0; $__LIST__ = $level1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($l1["id"]); ?>"><?php echo ($l1["name"]); ?></option>
	                              	   <?php $level2=M('product_catalog')->where('parent_id='.$l1['id'])->select() ?>   
	                              	   <?php if(is_array($level2)): $i = 0; $__LIST__ = $level2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l2): $mod = ($i % 2 );++$i;?><option value="<?php echo ($l2["id"]); ?>">└───<?php echo ($l2["name"]); ?></option>
