   ...
   <div class="wrapper wrapper-content">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form action="/TP/index.php/Admin/Product/add" method="post" enctype="multipart/form-data" class="form-horizontal" >
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-8"><input type="file" name="goods_img" />
                                 </div>
                             </div>
                             <div class="form-group">
